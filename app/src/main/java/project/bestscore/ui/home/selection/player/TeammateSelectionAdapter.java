...
public class TeammateSelectionAdapter extends RecyclerView.Adapter<TeammateSelectionViewholder> {
    ...
    public TeammateSelectionAdapter(Activity activity, TeammateSelection teammateSelection) {
    ...
    public TeammateSelectionViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TeammateSelectionViewholder holder = new TeammateSelectionViewholder(view, activity, this, tvNameOfPlayer, tvWinsOfPlayer, clBackground, teammateSelection);
        return holder;
    }
