...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String EVENT_PARCOUR_ID = "parcour_id";
    ...
    public boolean insertParcour(@NotNull Parcour parcour) {
        ...
        parcour_values.put(PARCOUR_NAME, parcour.getName());
    ...
    public Parcour getParcour(int parcourID){
        SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();

        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM " + PARCOUR + " WHERE " + PARCOUR_ID + " = \""
                + parcourID + "\"" , null);

        cursor.moveToFirst();

        Parcour parcour = new Parcour(
                cursor.getString(cursor.getColumnIndex(PARCOUR_NAME)),
                cursor.getInt(cursor.getColumnIndex(PARCOUR_ID)));
    ...
    public boolean updateParcour(@NotNull Parcour parcour){
        ...
        cv.put(PARCOUR_NAME, parcour.getName());
    ...
    public ArrayList<Event> getEvents() {
        ...
        while (!eventCursor.isAfterLast()) {
            ...
            while (!teammateCursor.isAfterLast()) {
                ...
                eventList.add(new Event(event_name, event_type, getParcour(eventCursor.getInt(eventCursor.getColumnIndex(EVENT_PARCOUR_ID))), event_date, teammateList, null, event_id));
